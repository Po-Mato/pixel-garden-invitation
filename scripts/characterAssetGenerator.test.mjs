...
test("generator copies guest sources without final-PNG pixel cleanup", async () => {
  const dir = await mkdtemp(join(tmpdir(), "character-source-copy-"));
  ...
  try {
    ...
    assert.deepEqual(generated, sourceBefore);
