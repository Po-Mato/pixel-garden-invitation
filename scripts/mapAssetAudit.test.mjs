...
test("wires font, gallery, map, character, photo-effect, and mobile visual audits into root scripts", async () => {
  ...
  assert.equal(
    ...
    "node scripts/audit-map-assets.mjs && node scripts/audit-map-foreground-placements.mjs && node scripts/audit-map-tone.mjs"
  );
  assert.equal(
