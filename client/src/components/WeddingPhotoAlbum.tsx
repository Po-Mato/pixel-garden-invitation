          ...
          <section className={`wedding-photo-strip${complete ? " is-complete" : ""}`} aria-label="세로 포토스트립" data-theme={stripTheme}>
            ...
            <div className="wedding-photo-strip__copy">
              ...
              <section className="wedding-photo-strip__editor" aria-label="포토스트립 편집">
                <PhotoCompositionTemplateControls contributorName={nickname} photoTransform={selectedTransform} stickerText={stripStickerText} stickerStyle={stripStickerStyle} stickerTransform={stripStickerTransform} onApply={applyTemplate} />
