...
function rectangles(guests: RemoteGuestNameplateSource[]) {
  const placements = placeRemoteGuestNameplates(guests);
...
function expectNoOverlap(guests: RemoteGuestNameplateSource[]) {
  const rects = rectangles(guests);
